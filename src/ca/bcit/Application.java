...
public class Application extends javafx.application.Application {
    ...
    private static void registerAlgorithms() throws Exception {
        ...
        Settings.registerAlgorithm("ca.bcit.net.algo.AMRA0");
        Settings.registerAlgorithm("ca.bcit.net.algo.AMRDA");
        Settings.registerAlgorithm("ca.bcit.net.algo.AMRDA2");
        Settings.registerAlgorithm("ca.bcit.net.algo.AMRDA3");
        Settings.registerAlgorithm("ca.bcit.net.algo.AMRDA4");
